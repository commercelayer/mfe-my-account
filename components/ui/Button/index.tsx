...
const PrimaryButton = styled.button<PrimaryButtonProps>`
  ${tw` text-center h-11 rounded-md shadow-sm disabled:opacity-50 hover:opacity-80 transition duration-500 ease-in-out`}
  ${({ buttonSize }) => (buttonSize == 'small' ? tw`px-5 h-5 text-3xs` : tw`px-7 h-11 text-ss`)}
