...
export function SkeletonBox({
  ...
  return (
    <div className={cn("bg-gray-300 rounded-xl", className)}>{children}</div>
  )
}
...
export function SkeletonCircle({
  ...
  return (
    <SkeletonBox className={cn("rounded-full", className)}>
      {children}
    </SkeletonBox>
  )
}
...
export function SkeletonWrapper({
  ...
  return (
    <div
      className={cn(
        "animate-pulse flex-shrink flex-grow",
        !visible && "hidden",
        className,
      )}
    >
...
export function SkeletonHeader({
  ...
  return (
    <SkeletonRow className={cn("items-center justify-between", className)}>
      {children}
    </SkeletonRow>
  )
}
...
export function SkeletonSubtitle({ className, size }: SkeletonSubtitleProps) {
  return (
    <SkeletonBox
      className={cn(
        `h-5 ${size === "small" ? "w-20" : size === "medium" ? "w-40" : "w-60"}`,
        className,
      )}
    />
  )
...
export function SkeletonTableRow({
  ...
  return (
    <div
      className={cn(
        "flex",
        align === "start" ? "justify-items-start" : "justify-between",
        className,
      )}
    >
      {children}
...
export function SkeletonTableTHead({
  children,
  className,
  align,
}: SkeletonTableRowProps) {
  return (
    <SkeletonTableRow align={align} className={cn("hidden md:flex", className)}>
      {children}
    </SkeletonTableRow>
  )
}
...
export function SkeletonSpan({ className, size }: SkeletonSpanProps) {
  ...
  return (
    <SkeletonBox className={cn("bg-gray-300 rounded", sizeCss, className)} />
  )
}
