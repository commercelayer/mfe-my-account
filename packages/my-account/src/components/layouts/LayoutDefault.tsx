      ...
      <Container>
        {isGuest ? (
          <div className="flex flex-wrap justify-end items-stretch flex-col max-w-screen-md mx-auto min-h-screen md:flex-row">
            <div
              id="main"
              className="flex-none justify-center order-first h-screen md:flex-1 md:order-last md:h-auto"
            >
          ...
          <div className="flex flex-wrap justify-end items-stretch flex-col min-h-screen md:flex-row">
            ...
            {ctx?.showMobileMenu && (
              <div className="z-20 fixed top-16 left-0 bottom-0 flex flex-col min-w-full max-w-sm bg-white border-r overflow-y-auto lg:hidden">
                {aside}
              </div>
            )}
            <div
